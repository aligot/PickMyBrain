    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(view -> {
            ...
            if(languageName.equals("")) //verifie qu'on ecrit bien qqch
                Toast.makeText(add_theme.this, "No theme is written", Toast.LENGTH_SHORT).show();
                ...
                if(!exists){ //si la langue n'existait pas, on vient lui ajouter des mots
                    ...
                    editText.setHint("Add a new theme...");
                    ...
                    Toast.makeText(add_theme.this, "You can add some vocabulary", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
