...
public class Revision extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        score = 0;
        Toast.makeText(Revision.this, "5 words test begins !", Toast.LENGTH_SHORT).show();
        ...
        btnValidate.setOnClickListener(view -> {
            ...
            if(cntTest < 5){ //si on s'est teste sur moins de 5 mots
                ...
                Toast.makeText(Revision.this, "Test is finished ! Score : "+ score +"/5",
    ...
    public void increment(){
        ...
        listcounter.add(counterLocal,String.valueOf(cnt));
        databaseReference.child(String.valueOf(counterLocal+1)).child("compteur").setValue(cnt);
        Toast.makeText(Revision.this, "Wrong traduction ! It was "+ tradListForRevision.
                get(wordListForRevision.indexOf(textWord.getText().toString())), Toast.LENGTH_SHORT).show();
